        ...
        <form className="flex flex-col">
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col">
              <label className="text-sm">Judul Vote</label>
          ...
          <div className="py-10 flex justify-end items-center gap-4">
            <Link href="/"><p className="text-xl font-bold">Kembali</p></Link>
            <Button text="Buat Vote 👍🏻" size="lg" onClick={createVote} />
          </div>
        </form>
      </div>
    </div>
...
function showAlert(arg0: { title: string; subtitle: string; }) {
