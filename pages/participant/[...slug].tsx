...
export default function DetailParticipate() {
  ...
  const submitVote = async () => {
    if (selectedCandidate) {
      showAlert({
        title: "Anda yakin?",
        subtitle: "Anda akan memilih " + selectedCandidate.name,
  ...
  return (
    <div className={`mb-10 ${isLoading && "animate-pulse"}`}>
      ...
      <div className="container mx-auto">
        <h1 className="text-4xl mt-10 text-center font-bold">{vote?.title}</h1>
        {/* Timer */}
        ...
        <div className="text-center mt-10">
          ...
          {participant && <span className="bg-zinc-100 py-2 px-3">Anda sudah memilih, dan tidak diperbolehkan untuk mengganti pilihan</span>}
